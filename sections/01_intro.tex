...
\begin{itemize}
  ...
  \item An evaluation spanning KITTI; two indoor multi-session deployments built from the
    LaMAR \cite{sarlin2022lamar} and CroCoDL \cite{blum2025crocodl} benchmarks (captured on a
    HoloLens/iPad and a Boston Dynamics Spot respectively); and Oxford RobotCar with RTK ground
